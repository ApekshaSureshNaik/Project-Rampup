...
const openedMixin = (theme: Theme): CSSObject => ({
  ...
  const columns: GridColDef[] = [
    ...
    renderCell: (cellValues) =>{ return (
      <Chip variant="outlined" className={styles.empbtn} 
      // onClick={(event) => {
...
const items=[
    ...
    {
        name:<Link href="" style={{textDecoration:"none"}}>Settings</Link>,
...
<Avatar  style={{ position:"absolute",width: 30, height: 30,left:1450,top:6}}  />
     ...
     <Divider style={{position:"relative",width:1500,bottom:-20}}/>
        ...
        <Button className={styles.button} style={{ marginLeft:"1220px", marginTop:"-50px", width:160}} onClick={()=>setShowModal(true)}>+ Add Employee</Button>
