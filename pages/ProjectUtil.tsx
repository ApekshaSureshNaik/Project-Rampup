...
import styles from "../styles/ProjectUtil.module.css"
    ...
    useEffect(() => {
      ...
      const modalContent = show ? (
        ...
        >
          ...
          <Button style={{color:"black",left:"610px"}}className={styles.btn2} onClick={onClose}>
            <CloseIcon />
            </Button>
        ...
        marginLeft:"-370px"
         ...
         <label className={styles.name1}>PROJECT NAME</label>
         <div className={styles.enter} style={{marginTop:"90px",marginLeft:"-10px"}}>
          <TextField style={{width:"400px"}} className="name"
            ...
            <label className={styles.name2}>PROJECT TYPE</label>
      ...
      <label className={styles.sal}>MONTHLY COST</label>
         <div className={styles.enter} style={{marginTop:"20px",marginLeft:"-2px"}}>
          <TextField style={{width:"210px"}} className="name"
            ...
            <label className={styles.total}>MONTHLY UTILIZATION</label>
         <div className={styles.enter} style={{marginTop:"-40px",marginLeft:"220px"}}>
          <TextField style={{width:"210px"}} className="name"
            ...
            <label className={styles.loss}>COST YTD</label>
         <div className={styles.enter} style={{marginTop:"-40px",marginLeft:"440px"}}>
          <TextField style={{width:"210px"}} className="name"
            ...
            <Box>
        <Typography className={styles.projname}>EMPLOYEE NAME </Typography>
      ...
      <Box>
        <Typography className={styles.projname1}>EMPLOYEE NAME</Typography>
      ...
      <label className={styles.util}>UTILIZATION</label>
         <div className={styles.enter} style={{marginTop:"-120px",marginLeft:"290px"}}>
          <TextField style={{width:"140px"}} className="name"
             placeholder="0"
            variant="outlined"
            size="small"/>
      ...
      <label className={styles.cost}>COST</label>
         <div className={styles.enter} style={{marginTop:"-40px",marginLeft:"450px"}}>
          <TextField style={{width:"140px"}} className="name"
             placeholder="0"
            variant="outlined"
            size="small"/>
             <IconButton style={{marginLeft:"150px",marginTop:"-70px",color:"red"}}>
             <DeleteOutlineIcon/>
            </IconButton>
            </div>
         ...
         <div className={styles.enter} style={{marginTop:"15px",marginLeft:"290px"}}>
          <TextField style={{width:"140px"}} className="name"
             placeholder="0"
            variant="outlined"
            size="small"/>
            ...
            <label className={styles.cost1}>COST</label>
         <div className={styles.enter} style={{marginTop:"-40px",marginLeft:"450px"}}>
          <TextField style={{width:"140px"}} className="name"
             placeholder="0"
            variant="outlined"
            size="small"/>
            <IconButton style={{marginLeft:"150px",color:"red",marginTop:"-70px"}}>
             <DeleteOutlineIcon/>
            </IconButton>
            </div>
