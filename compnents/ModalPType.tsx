  ...
  const [_document, setDocument] = useState<Document | null>(null);
    ...
    useEffect(() => {
      ...
      const modalContent = show ? (
        ...
        <label className={styles.heading}  style={{marginTop:"-130px",marginLeft:"-370px"}}>Add Project Type</label>
        <div className={styles.line}  style={{marginTop:"-130px",marginLeft:"-370px"}}></div>
        <label className={styles.name} style={{marginTop:"-130px",marginLeft:"-370px"}}>Project Type Name</label> 
        <input type="text" className={styles.input} placeholder="Enter" style={{marginTop:"-130px",marginLeft:"-370px"}}></input>
        <label className={styles.description} style={{marginTop:"-130px",marginLeft:"-370px"}}>Project Type Description</label>
        ...
        <label className={styles.status} style={{marginTop:"-130px",marginLeft:"-370px"}}>Project Type Status</label>
